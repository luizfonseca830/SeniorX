 ...
 * 
 */
public class CalculadoraDivisaoImpl {
	...
	public CalculadoraDivisaoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(FieldCalculadora input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CALCULADORA_DIVISAO, //
	...
	* Realiza a operação matematica de divisão
	*/
	public CompletableFuture<FieldResultadoCalculadora> calculadoraDivisaoRequest(FieldCalculadora input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);

...
import br.com.senior.mydomain.myservice.CreateBulkConvidadoInput;
import br.com.senior.mydomain.myservice.CreateBulkConvidadoOutput;
 ...
 * 
 */
public class CreateBulkConvidadoImpl {
	...
	public CreateBulkConvidadoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkConvidadoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.CREATE_BULK_CONVIDADO, //
	...
	*/
	public CreateBulkConvidadoOutput createBulkConvidado(CreateBulkConvidadoInput input, long timeout) {
		...
		CreateBulkConvidadoOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkConvidadoOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<CreateBulkConvidadoOutput> createBulkConvidadoRequest(CreateBulkConvidadoInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkConvidadoOutput.class);
	}
	...
	* The 'createBulk' request primitive for the Convidado entity.
	*/
	public CompletableFuture<CreateBulkConvidadoOutput> createBulkConvidadoRequest(CreateBulkConvidadoInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkConvidadoOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}

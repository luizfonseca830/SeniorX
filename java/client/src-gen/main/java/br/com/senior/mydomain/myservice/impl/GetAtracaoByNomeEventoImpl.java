 ...
 * 
 */
public class GetAtracaoByNomeEventoImpl {
	...
	public GetAtracaoByNomeEventoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(GetAtracaoByNomeEventoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.GET_ATRACAO_BY_NOME_EVENTO, //
	...
	*/
	public GetAtracaoByNomeEventoOutput getAtracaoByNomeEvento(GetAtracaoByNomeEventoInput input, long timeout) {
		...
		GetAtracaoByNomeEventoOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), GetAtracaoByNomeEventoOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<GetAtracaoByNomeEventoOutput> getAtracaoByNomeEventoRequest(GetAtracaoByNomeEventoInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, GetAtracaoByNomeEventoOutput.class);
	}
	...
	* 
	*/
	public CompletableFuture<GetAtracaoByNomeEventoOutput> getAtracaoByNomeEventoRequest(GetAtracaoByNomeEventoInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, GetAtracaoByNomeEventoOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}

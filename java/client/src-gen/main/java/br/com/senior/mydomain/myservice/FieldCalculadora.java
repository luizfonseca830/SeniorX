...
public class FieldCalculadora {
    ...
    public FieldCalculadora() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public FieldCalculadora(Double numero1, Double numero2) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof FieldCalculadora)) {
            return false;
        }
        FieldCalculadora other = (FieldCalculadora) obj;
    ...
    public void toString(StringBuilder sb, List<Object> appended) {
    	FieldCalculadoraStringSerializer.INSTANCE.serialize(this, sb, appended);
    }

...
import br.com.senior.mydomain.myservice.ExportEventoInput;
import br.com.senior.mydomain.myservice.ExportEventoOutput;
...
public class ExportEventoImpl {
	...
	private Message createMessage(ExportEventoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.EXPORT_EVENTO, //
	...
	* 
	*/
	public CompletableFuture<ExportEventoOutput> exportEventoRequest(ExportEventoInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ExportEventoOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}

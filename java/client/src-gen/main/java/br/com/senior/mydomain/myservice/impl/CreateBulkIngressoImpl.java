...
import br.com.senior.mydomain.myservice.CreateBulkIngressoInput;
import br.com.senior.mydomain.myservice.CreateBulkIngressoOutput;
 ...
 * 
 */
public class CreateBulkIngressoImpl {
	...
	public CreateBulkIngressoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkIngressoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.CREATE_BULK_INGRESSO, //
	...
	*/
	public CreateBulkIngressoOutput createBulkIngresso(CreateBulkIngressoInput input, long timeout) {
		...
		CreateBulkIngressoOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkIngressoOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<CreateBulkIngressoOutput> createBulkIngressoRequest(CreateBulkIngressoInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkIngressoOutput.class);
	}
	...
	* The 'createBulk' request primitive for the Ingresso entity.
	*/
	public CompletableFuture<CreateBulkIngressoOutput> createBulkIngressoRequest(CreateBulkIngressoInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkIngressoOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}

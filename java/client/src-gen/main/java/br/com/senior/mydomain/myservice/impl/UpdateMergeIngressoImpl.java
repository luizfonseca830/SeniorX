 ...
 * 
 */
public class UpdateMergeIngressoImpl {
	...
	public UpdateMergeIngressoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Ingresso input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.UPDATE_MERGE_INGRESSO, //
	...
	* The 'updateMerge' request primitive for the Ingresso entity.
	*/
	public CompletableFuture<Ingresso> updateMergeIngressoRequest(Ingresso input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);

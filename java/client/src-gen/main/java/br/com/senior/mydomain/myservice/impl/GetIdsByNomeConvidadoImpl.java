 ...
 * 
 */
public class GetIdsByNomeConvidadoImpl {
	...
	public GetIdsByNomeConvidadoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(GetIdsByNomeConvidadoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.GET_IDS_BY_NOME_CONVIDADO, //
	...
	*/
	public GetIdsByNomeConvidadoOutput getIdsByNomeConvidado(GetIdsByNomeConvidadoInput input, long timeout) {
		...
		GetIdsByNomeConvidadoOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), GetIdsByNomeConvidadoOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<GetIdsByNomeConvidadoOutput> getIdsByNomeConvidadoRequest(GetIdsByNomeConvidadoInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, GetIdsByNomeConvidadoOutput.class);
	}
	...
	* 
	*/
	public CompletableFuture<GetIdsByNomeConvidadoOutput> getIdsByNomeConvidadoRequest(GetIdsByNomeConvidadoInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, GetIdsByNomeConvidadoOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}

 ...
 * 
 */
public class UpdateIngressoImpl {
	...
	public UpdateIngressoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Ingresso input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.UPDATE_INGRESSO, //
	...
	* The 'update' request primitive for the Ingresso entity.
	*/
	public CompletableFuture<Ingresso> updateIngressoRequest(Ingresso input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);

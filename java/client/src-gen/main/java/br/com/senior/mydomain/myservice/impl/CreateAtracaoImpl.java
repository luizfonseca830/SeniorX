 ...
 * 
 */
public class CreateAtracaoImpl {
	...
	public CreateAtracaoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Atracao input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CREATE_ATRACAO, //
	...
	* The 'create' request primitive for the Atracao entity.
	*/
	public CompletableFuture<Atracao> createAtracaoRequest(Atracao input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);

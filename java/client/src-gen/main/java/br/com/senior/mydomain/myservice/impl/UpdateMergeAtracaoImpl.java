 ...
 * 
 */
public class UpdateMergeAtracaoImpl {
	...
	public UpdateMergeAtracaoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Atracao input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.UPDATE_MERGE_ATRACAO, //
	...
	* The 'updateMerge' request primitive for the Atracao entity.
	*/
	public CompletableFuture<Atracao> updateMergeAtracaoRequest(Atracao input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);

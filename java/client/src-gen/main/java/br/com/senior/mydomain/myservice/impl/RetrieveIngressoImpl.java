 ...
 * 
 */
public class RetrieveIngressoImpl {
	...
	public RetrieveIngressoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Ingresso.GetRequest input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.RETRIEVE_INGRESSO, //
	...
	* The 'retrieve' request primitive for the Ingresso entity.
	*/
	public CompletableFuture<Ingresso> retrieveIngressoRequest(Ingresso.GetRequest input, long timeout, TimeUnit unit) {

 ...
 * 
 */
public class CreateMergeAtracaoImpl {
	...
	public CreateMergeAtracaoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(Atracao input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.CREATE_MERGE_ATRACAO, //
	...
	* The 'createMerge' request primitive for the Atracao entity.
	*/
	public CompletableFuture<Atracao> createMergeAtracaoRequest(Atracao input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);

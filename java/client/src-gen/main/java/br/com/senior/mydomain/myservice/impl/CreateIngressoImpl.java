 ...
 * 
 */
public class CreateIngressoImpl {
	...
	public CreateIngressoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Ingresso input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CREATE_INGRESSO, //
	...
	* The 'create' request primitive for the Ingresso entity.
	*/
	public CompletableFuture<Ingresso> createIngressoRequest(Ingresso input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);

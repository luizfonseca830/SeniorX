...
public class CalculadoraInput {
    ...
    public CalculadoraInput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public CalculadoraInput(Long numero1, Long numero2) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CalculadoraInput)) {
            return false;
        }
        CalculadoraInput other = (CalculadoraInput) obj;
    ...
    public void toString(StringBuilder sb, List<Object> appended) {
    	CalculadoraInputStringSerializer.INSTANCE.serialize(this, sb, appended);
    }

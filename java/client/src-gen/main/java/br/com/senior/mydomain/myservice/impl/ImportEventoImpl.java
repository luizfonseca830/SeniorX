...
import br.com.senior.mydomain.myservice.ImportEventoInput;
import br.com.senior.mydomain.myservice.ImportEventoOutput;
...
public class ImportEventoImpl {
	...
	private Message createMessage(ImportEventoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.IMPORT_EVENTO, //
	...
	* 
	*/
	public CompletableFuture<ImportEventoOutput> importEventoRequest(ImportEventoInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ImportEventoOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}

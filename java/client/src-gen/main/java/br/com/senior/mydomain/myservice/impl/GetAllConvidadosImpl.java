 ...
 * 
 */
public class GetAllConvidadosImpl {
	...
	public GetAllConvidadosImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(GetAllConvidadosInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.GET_ALL_CONVIDADOS, //
	...
	*/
	public GetAllConvidadosOutput getAllConvidados(GetAllConvidadosInput input, long timeout) {
		...
		GetAllConvidadosOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), GetAllConvidadosOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<GetAllConvidadosOutput> getAllConvidadosRequest(GetAllConvidadosInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, GetAllConvidadosOutput.class);
	}
	...
	* 
	*/
	public CompletableFuture<GetAllConvidadosOutput> getAllConvidadosRequest(GetAllConvidadosInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, GetAllConvidadosOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}

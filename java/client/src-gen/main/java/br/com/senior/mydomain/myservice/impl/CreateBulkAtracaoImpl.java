...
import br.com.senior.mydomain.myservice.CreateBulkAtracaoInput;
import br.com.senior.mydomain.myservice.CreateBulkAtracaoOutput;
 ...
 * 
 */
public class CreateBulkAtracaoImpl {
	...
	public CreateBulkAtracaoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkAtracaoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.CREATE_BULK_ATRACAO, //
	...
	*/
	public CreateBulkAtracaoOutput createBulkAtracao(CreateBulkAtracaoInput input, long timeout) {
		...
		CreateBulkAtracaoOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkAtracaoOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<CreateBulkAtracaoOutput> createBulkAtracaoRequest(CreateBulkAtracaoInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkAtracaoOutput.class);
	}
	...
	* The 'createBulk' request primitive for the Atracao entity.
	*/
	public CompletableFuture<CreateBulkAtracaoOutput> createBulkAtracaoRequest(CreateBulkAtracaoInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkAtracaoOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}

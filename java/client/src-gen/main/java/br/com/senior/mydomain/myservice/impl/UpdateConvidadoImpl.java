 ...
 * 
 */
public class UpdateConvidadoImpl {
	...
	public UpdateConvidadoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Convidado input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.UPDATE_CONVIDADO, //
	...
	* The 'update' request primitive for the Convidado entity.
	*/
	public CompletableFuture<Convidado> updateConvidadoRequest(Convidado input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);

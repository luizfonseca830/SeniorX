 ...
 * 
 */
public class CalculadoraAdicaoImpl {
	...
	public CalculadoraAdicaoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(FieldCalculadora input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CALCULADORA_ADICAO, //
	...
	* Realiza a operação matematica de adição
	*/
	public CompletableFuture<FieldResultadoCalculadora> calculadoraAdicaoRequest(FieldCalculadora input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);

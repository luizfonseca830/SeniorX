...
import br.com.senior.mydomain.myservice.FindIngressoBynomeConvidadoInput;
import br.com.senior.mydomain.myservice.FindIngressoBynomeConvidadoOutput;
 ...
 * 
 */
public class FindIngressoBynomeConvidadoImpl {
	...
	public FindIngressoBynomeConvidadoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(FindIngressoBynomeConvidadoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.FIND_INGRESSO_BYNOME_CONVIDADO, //
	...
	*/
	public FindIngressoBynomeConvidadoOutput findIngressoBynomeConvidado(FindIngressoBynomeConvidadoInput input, long timeout) {
		...
		FindIngressoBynomeConvidadoOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), FindIngressoBynomeConvidadoOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<FindIngressoBynomeConvidadoOutput> findIngressoBynomeConvidadoRequest(FindIngressoBynomeConvidadoInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, FindIngressoBynomeConvidadoOutput.class);
	}
	...
	* 
	*/
	public CompletableFuture<FindIngressoBynomeConvidadoOutput> findIngressoBynomeConvidadoRequest(FindIngressoBynomeConvidadoInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, FindIngressoBynomeConvidadoOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}

...
public class ListEventoImpl {
	...
	private Message createMessage(Evento.PageRequest input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.LIST_EVENTO, //
	...
	* The 'list' request primitive for the Evento entity.
	*/
	public CompletableFuture<Evento.PagedResults> listEventoRequest(Evento.PageRequest input, long timeout, TimeUnit unit) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, Evento.PagedResults.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}

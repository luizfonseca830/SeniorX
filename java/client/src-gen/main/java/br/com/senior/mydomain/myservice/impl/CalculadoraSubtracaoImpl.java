 ...
 * 
 */
public class CalculadoraSubtracaoImpl {
	...
	public CalculadoraSubtracaoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(FieldCalculadora input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CALCULADORA_SUBTRACAO, //
	...
	* Realiza a operação matematica de subtração
	*/
	public CompletableFuture<FieldResultadoCalculadora> calculadoraSubtracaoRequest(FieldCalculadora input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);

 ...
 * 
 */
public class CreateConvidadoImpl {
	...
	public CreateConvidadoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Convidado input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CREATE_CONVIDADO, //
	...
	* The 'create' request primitive for the Convidado entity.
	*/
	public CompletableFuture<Convidado> createConvidadoRequest(Convidado input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);

 ...
 * 
 */
public class UpdateMergeEvento_IngressosImpl {
	...
	public UpdateMergeEvento_IngressosImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Ingresso input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.UPDATE_MERGE_EVENTO_INGRESSOS, //
	...
	* The 'updateMerge' request primitive for the ingressos attribute of evento entity.\nThis primitive requires the header 'entity_parent_id' with id of parent evento entity.
	*/
	public CompletableFuture<Ingresso> updateMergeEvento_IngressosRequest(Evento.Id parentId, Ingresso input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);

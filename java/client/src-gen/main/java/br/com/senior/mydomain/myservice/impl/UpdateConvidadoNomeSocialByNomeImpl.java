 ...
 * 
 */
public class UpdateConvidadoNomeSocialByNomeImpl {
	...
	public UpdateConvidadoNomeSocialByNomeImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(UpdateConvidadoNomeSocialByNomeInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.UPDATE_CONVIDADO_NOME_SOCIAL_BY_NOME, //
	...
	*/
	public UpdateConvidadoNomeSocialByNomeOutput updateConvidadoNomeSocialByNome(UpdateConvidadoNomeSocialByNomeInput input, long timeout) {
		...
		UpdateConvidadoNomeSocialByNomeOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), UpdateConvidadoNomeSocialByNomeOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<UpdateConvidadoNomeSocialByNomeOutput> updateConvidadoNomeSocialByNomeRequest(UpdateConvidadoNomeSocialByNomeInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, UpdateConvidadoNomeSocialByNomeOutput.class);
	}
	...
	* 
	*/
	public CompletableFuture<UpdateConvidadoNomeSocialByNomeOutput> updateConvidadoNomeSocialByNomeRequest(UpdateConvidadoNomeSocialByNomeInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, UpdateConvidadoNomeSocialByNomeOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}

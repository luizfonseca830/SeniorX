/* Database: Oracle. Generation date: 2024-03-26 10:24:23:418 */
/* Entity Convidado */
...
alter table ingresso add constraint fkiu2edljzjudcpn2r9pa1ppuyxrsw foreign key (convidado) references convidado (id);
alter table ingresso add constraint fk4h9uasulapu58cenidp0xoaepcug foreign key (evento) references evento (id);
alter table atracao add constraint fkjokqkr8orcc99mjrohgbxz8iyusk foreign key (evento) references evento (id);
